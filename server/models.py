...
class Restaurant(db.Model, SerializerMixin):
    ...
    # add relationship
    restaurant_pizza = db.relationship('RestaurantPizza', back_populates="restaurant", cascade="delete")
...
class Pizza(db.Model, SerializerMixin):
    ...
    # add relationship
    restaurant_pizza = db.relationship('RestaurantPizza', back_populates="pizza", cascade="delete")
